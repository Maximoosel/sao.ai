      ...
      <section id="pricing" className="py-24 px-6 relative">
        ...
        <div className="max-w-md mx-auto relative z-10">
          ...
          >
            ...
            <p className="text-white/30 text-sm max-w-sm mx-auto">One payment. Unlimited use. Forever.</p>
          </motion.div>

          <motion.div
            className="rounded-2xl border border-primary/20 bg-primary/[0.04] p-8 backdrop-blur-sm relative overflow-hidden text-center"
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
          >
            ...
            <p className="text-xs text-white/25 mb-6">Pay once, use forever</p>
            <div className="space-y-2.5 text-left max-w-xs mx-auto mb-8">
              {['Unlimited folder scans', 'AI file analysis', 'One-click sweep', 'All future updates', 'Priority support'].map((f) => (
      ...
      <section className="py-20 px-6 relative">
        ...
        <div className="max-w-xl mx-auto relative z-10">
          ...
          <div className="grid grid-cols-3 gap-3">
            {[
              { amount: '$2', label: 'Hot Chocolate', tier: 'coffee' },
              { amount: '$5', label: 'Lunch', tier: 'lunch' },
              { amount: '$10', label: 'A Sandwich', tier: 'hero' },
            ].map((tip, i) => (
              <motion.button
                key={tip.amount}
